...
const ParentProfile = () => {
  ...
  const handleSave = async e => {
    ...
    try {
      ...
      if (step === 1) {
        if (!profile.childName.trim()) errors.childName = 'Student name is required';
        if (!profile.childAge) errors.childAge = 'Age is required';
        if (!profile.childGrade) errors.childGrade = 'Grade is required';
        if (selectedSubjects.length === 0) errors.subjects = 'At least one subject is required';
      } else {
        if (!profile.name.trim()) errors.name = 'Parent name is required';
                    ...
                    <form onSubmit={handleNext}>
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-3">
                          ...
                          <input
                            type="text"
                            className={`form-control ${fieldErrors.childName ? 'is-invalid' : ''}`}
                            name="childName"
                            value={profile.childName}
                            onChange={handleChange}
                            style={{
                              borderColor: fieldErrors.childName ? '#dc3545' : '#e2e8f0',
                              borderRadius: '0.5rem'
                            }}
                          />
                        ...
                        <div className="col-md-3 mb-3">
                          ...
                          <input
                            type="number"
                            className={`form-control ${fieldErrors.childAge ? 'is-invalid' : ''}`}
                            name="childAge"
                            ...
                            max="18"
                            style={{
                              borderColor: fieldErrors.childAge ? '#dc3545' : '#e2e8f0',
                              borderRadius: '0.5rem'
                            }}
                          />
                        ...
                        <div className="col-md-3 mb-3">
                          ...
                          <select
                            className={`form-select ${fieldErrors.childGrade ? 'is-invalid' : ''}`}
                            name="childGrade"
                            value={profile.childGrade}
                            onChange={handleChange}
                            style={{
                              borderColor: fieldErrors.childGrade ? '#dc3545' : '#e2e8f0',
                              borderRadius: '0.5rem'
                            }}
                          >
                        ...
                        <div className="mb-3">
                          ...
                          <div className="d-flex flex-wrap gap-2 mb-2">
                            {selectedSubjects.map(subj => (
                              <span key={subj._id || subj} className="badge px-3 py-2" style={{ backgroundColor: '#14b8a6' }}>
                                {(subjects.find(s => s._id === (subj._id || subj))?.name) || 'Unknown Subject'}
                                <span style={{ cursor: 'pointer', marginLeft: 6 }} onClick={() => handleSubjectRemove(subj)}>&times;</span>
                              </span>
                            ))}
                          </div>
                          ...
                          <select
                            className={`form-select ${fieldErrors.subjects ? 'is-invalid' : ''}`}
                            onChange={e => {
                            ...
                            value=""
                            style={{
                              borderColor: fieldErrors.subjects ? '#dc3545' : '#e2e8f0',
                              borderRadius: '0.5rem'
                            }}
                          >
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-3">
                          ...
                          <input
                            ...
                            onChange={handleChange}
                            style={{
                              borderColor: fieldErrors.name ? '#dc3545' : '#e2e8f0',
                              borderRadius: '0.5rem'
                            }}
                          />
                          {fieldErrors.name && (
